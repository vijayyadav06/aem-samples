<%--
Updates by: ryan.mccullough, joe.gergis
...
%><%@page session="false"
		  ...
		  com.medtronic.com.services.Java8CollectionSort,
		  com.medtronic.com.services.KeyValue"%><%--###
Languages
=========
...
//    });
    ...
    Java8CollectionSort.sort(languages, request.getLocale());
    ...
    DataSource ds = new SimpleDataSource(new TransformIterator(languages.iterator(), new Transformer() {
        public Object transform(Object input) {
            try {
                ...
                vm.put("value", lang.getKey());
                vm.put("text", lang.getValue());
