...
<object class="GenericRobot2" serializationversion="1">
  ...
  <property name="variables" class="Variables">
    ...
    <object class="Variable" serializationversion="1">
      <property name="name" class="String" id="1">redirect</property>
      <property name="initialAssignment" class="InitialVariableAssignment">
        <property name="type" class="TypeReference" serializationversion="0">
          <property name="typeName" idref="1"/>
        </property>
      </property>
    </object>
    <object class="Variable" serializationversion="1">
    ...
    <steps class="ArrayList">
      ...
      <object class="Transition" serializationversion="0" id="6">
        ...
        <property name="stepAction" class="QueryDatabase2" serializationversion="1">
          ...
          <property name="sql" class="String">"SELECT objectkey FROM content where crawled='y' and release_phase='"+release_phase+"' and include_in_migration='y' and http_status='200'"</property>
        ...
        <property name="stepAction" class="CreatePage2">
          ...
          <property name="browserConfigurationSpecification" class="BrowserConfigurationSpecificationWebKit" serializationversion="20">
            ...
            <property name="changedProperties" class="java.util.HashSet">
              <element class="String" id="9">executeJavaScript</element>
            </property>
          </property>
        </property>
      ...
      <object class="Transition" serializationversion="0" id="11">
        <property name="name" class="String" id="12">each A</property>
      ...
      <object class="Transition" serializationversion="0" id="20">
        <property name="name" class="String" id="21">Find in Database</property>
        <property name="stepAction" class="FindInDatabase" serializationversion="0">
          <property name="db" class="kapow.robot.plugin.common.support.expression.stringexpr.DBNameValueStringExpression">
            <property name="value" class="kapow.util.db.DBName">
              <property name="name" class="String" id="22">medtronic</property>
            </property>
          </property>
          <property name="variableName" class="kapow.robot.plugin.common.support.VariableName">
