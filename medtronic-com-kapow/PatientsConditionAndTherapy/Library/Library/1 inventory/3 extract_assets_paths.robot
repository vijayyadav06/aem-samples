...
<object class="GenericRobot2" serializationversion="1">
  <prologue>
    ...
    <referenced-types>
      <type name="asset"/>
      <type name="asset_path"/>
    </referenced-types>
    <referenced-snippets/>
    <typed-variables>
      <typed-variable name="asset" type-name="asset"/>
      <typed-variable name="asset_path" type-name="asset_path"/>
    </typed-variables>
    <global-variables/>
    <parameters/>
    <return-variables/>
    <store-in-database-variables>
      <variable name="asset_path"/>
    </store-in-database-variables>
  ...
  <property name="variables" class="Variables">
    ...
    <object class="Variable" serializationversion="1">
      <property name="name" class="String">asset_path</property>
      <property name="initialAssignment" class="InitialVariableAssignment">
        <property name="type" class="TypeReference" serializationversion="0">
          <property name="typeName" class="String">asset_path</property>
        </property>
      </property>
    </object>
  </property>
  ...
  <property name="transitionGraph" class="Body">
    ...
    <steps class="ArrayList">
      <object class="Transition" serializationversion="0" id="2">
        <property name="name" class="String">assets</property>
        <property name="stepAction" class="QueryDatabase2" serializationversion="1">
          ...
          <property name="sql" class="String">"SELECT objectkey FROM asset where include_in_migration='y'"</property>
      ...
      <object class="Transition" serializationversion="0" id="3">
        ...
        <property name="stepAction" class="FindInDatabase" serializationversion="0">
          ...
          <property name="onlyOverrideEmptyAttributes" class="Boolean">true</property>
        </property>
        <property name="elementFinders" class="ElementFinders"/>
        <property name="errorHandler" class="ErrorHandler" serializationversion="0"/>
        <property name="comment">
      ...
      <object class="Transition" serializationversion="0" id="5">
        ...
        <property name="stepAction" class="AssignVariable" serializationversion="2">
          ...
          <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
            <property name="name" class="String">asset_path.path</property>
          </property>
        </property>
      ...
      <object class="Transition" serializationversion="0" id="10">
        <property name="name" class="String">update count</property>
        <property name="stepAction" class="AssignVariable" serializationversion="2">
          <property name="stringExpr" class="Expression" serializationversion="1">
            <property name="text" class="String">asset_path.file_count+1</property>
          </property>
          <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
            <property name="name" class="String">asset_path.file_count</property>
          </property>
        </property>
