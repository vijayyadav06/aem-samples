...
<object class="GenericRobot2" serializationversion="1">
  <prologue>
    ...
    <referenced-types>
      <type name="content"/>
      <type name="t_condition_therapy"/>
    </referenced-types>
    <referenced-snippets/>
    <typed-variables>
      <typed-variable name="content" type-name="content"/>
      <typed-variable name="t_condition_therapy" type-name="t_condition_therapy"/>
    </typed-variables>
    <global-variables>
      <variable name="t_condition_therapy"/>
    </global-variables>
    <parameters/>
    <return-variables/>
  ...
  <property name="variables" class="Variables">
    ...
    <object class="Variable" serializationversion="1">
      <property name="name" class="String" id="2">t_condition_therapy</property>
      <property name="global" class="Boolean">true</property>
      <property name="initialAssignment" class="InitialVariableAssignment">
        <property name="type" class="TypeReference" serializationversion="0">
          <property name="typeName" class="String">t_condition_therapy</property>
        </property>
      </property>
    </object>
  </property>
  ...
  <property name="transitionGraph" class="Body">
    ...
    <steps class="ArrayList">
      <object class="Transition" serializationversion="0" id="5">
        <property name="name" class="String" id="6">Therapy Detail</property>
        <property name="stepAction" class="QueryDatabase2" serializationversion="1">
          ...
          <property name="sql" class="String">"SELECT objectkey FROM content where target_type='Therapy Detaill' and crawled='y'"</property>
