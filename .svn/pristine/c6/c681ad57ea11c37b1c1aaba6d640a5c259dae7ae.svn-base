...
<object class="GenericRobot2" serializationversion="1">
  ...
  <property name="variables" class="Variables">
    ...
    <object class="Variable" serializationversion="1">
      <property name="name" class="String" id="1">release_phase</property>
      <property name="initialAssignment" class="InitialVariableAssignment">
  ...
  <property name="transitionGraph" class="Body">
    ...
    <steps class="ArrayList">
      <object class="Transition" serializationversion="0" id="4">
        ...
        <property name="enabled" class="Boolean" id="6">false</property>
      </object>
      ...
      <object class="Transition" serializationversion="0" id="10">
        ...
        <property name="stepAction" class="FindInDatabase" serializationversion="0">
          <property name="db" class="kapow.robot.plugin.common.support.expression.stringexpr.DBNameValueStringExpression">
            <property name="value" class="kapow.util.db.DBName">
              <property name="name" class="String" id="11">condition_therapy</property>
            </property>
          </property>
      ...
      <object class="Transition" serializationversion="0" id="17">
        ...
        <property name="stepAction" class="ForEachTagPath" serializationversion="0">
          ...
          <property name="tagName" class="DesiredElementName">
            <property name="name" class="String" id="18">link</property>
          </property>
        </property>
        <property name="elementFinders" class="ElementFinders">
      ...
      <object class="Try" id="26">
        <property name="name" class="String" id="27">collect</property>
      </object>
      ...
      <object class="Transition" serializationversion="0" id="41">
        <property name="name" class="String" id="42">Store in Database</property>
      ...
      <object class="Transition" serializationversion="0" id="50">
        ...
        <property name="stepAction" class="ForEachTagPath" serializationversion="0">
          ...
          <property name="tagName" class="DesiredElementName">
            <property name="name" class="String" id="51">link</property>
          </property>
        </property>
        <property name="elementFinders" class="ElementFinders">
          <object class="DefaultNamedElementAwareDOMElementFinder" serializationversion="4">
